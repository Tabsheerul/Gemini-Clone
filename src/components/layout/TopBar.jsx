...
const MODELS = [
  { id: 'gemini-2.0-flash', label: 'Flash',   full: 'Gemini 2.0 Flash' },
  { id: 'gemini-1.5-pro',   label: 'Pro',     full: 'Gemini 1.5 Pro'   },
  { id: 'gemini-1.5-flash', label: 'Flash',   full: 'Gemini 1.5 Flash'  },
];
 ...
 * TopBar
 *
 * Exact match to the reference screenshot:
 *   Left  → "Gemini" plain text
 *   Right → "✦ Upgrade to Google AI Plus" gradient pill + user avatar circle
 */
